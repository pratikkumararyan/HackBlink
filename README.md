...
The stasis project validation system wasn't letting my easyeda files thorugh so I used an online converter to convert into a .kicad file, use only the real one tho for pcb!
